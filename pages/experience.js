      ...
      <div className="nes-container">
        ...
        <div className="lists">
          ...
          <ul>
            ...
            <div className="nes-badge ">
              <span className="is-error">EXT Net MVC</span>
            </div>
            <div className="nes-badge">
          ...
          <ul className="nes-list is-disc">
            <li>
              <p>
                ...
                out the installation, configuration, and administration of more
                than one thousand eight hundred computers. We were also able to
                reduce customer waiting times by 40% when we implemented a
                robust IVR system
              </p>
            </li>
          </ul>
